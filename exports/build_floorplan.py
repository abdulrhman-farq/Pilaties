...
room(ax, 3.5, 3.8, 6.5, 6)       # ركن الأجهزة الكلاسيكية
lbl(ax, 5.0, 5.1, "ركن الأجهزة الكلاسيكية\n(Cadillac / Chair) · 7 م²", 9.5, TEAL, True)
...
notes = [
    ...
    "ركن الأجهزة الكلاسيكية للجلسات الخاصة.",
]
yy = 0.47
for n in notes:
