...
lbl(ax, 5, 11.4, "استوديو التمرين (Reformer Studio)", 14, NAVY, True)
lbl(ax, 5, 10.95, "60 م²", 12, NAVY)

# الكتلة اليسرى (خدمات رطبة)
room(ax, 0, 0, 3.5, 2.2)         # دورات مياه + دش
lbl(ax, 1.75, 1.1, "دورات مياه + دش\n8 م²", 11)
room(ax, 0, 2.2, 3.5, 6)         # تبديل + خزائن
lbl(ax, 1.75, 4.1, "تبديل الملابس\n+ خزائن (Lockers)\n13 م²", 11)

# الكتلة الوسطى
room(ax, 3.5, 0, 6.5, 2)         # غرفة الأدوات
lbl(ax, 5.0, 1.0, "غرفة الأدوات\nProps · 6 م²", 10.5)
room(ax, 3.5, 2, 6.5, 3.8)       # مكتب الموظفات
lbl(ax, 5.0, 2.9, "مكتب الموظفات\n5 م²", 10.5)
room(ax, 3.5, 3.8, 6.5, 6)       # ركن التعافي
lbl(ax, 5.0, 4.9, "ركن التعافي\n(Recovery) · 7 م²", 10.5, TEAL, True)

# الكتلة اليمنى (مدخل + استقبال + انتظار)
room(ax, 6.5, 0, 10, 6, "#F3F7FB")
lbl(ax, 8.25, 5.4, "منطقة المدخل والاستقبال والانتظار · 21 م²", 10.5, NAVY, True)
