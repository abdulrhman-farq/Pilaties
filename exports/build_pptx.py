...
# 9 — تحليل الحساسية
s = slide(); title_bar(s, "تحليل الحساسية ومتانة النموذج", 9)
table(s, [
...
], Inches(0.9), Inches(1.6), Inches(11.5), Inches(2.6),
    highlight={1: GREEN}, font_size=15)
text(s, Inches(0.7), Inches(4.6), Inches(12), Inches(1.6), [
    "القرار المعتمد: سعر القائمة ~172.5 ريال شامل الضريبة (الصافي 150) — الحالة (أ).",
    "رسوم الدفع والإهلاك أثرهما طفيف؛ معالجة الضريبة هي المتغيّر الحاسم،",
    "والمشروع يبقى مجدياً حتى في الحالة الأكثر تحفظاً.",
], size=18, color=NAVY)

# 10 — خطة النمو
s = slide(); title_bar(s, "خطة النمو", 10)
bullets(s, [
...
# 11 — المخاطر
s = slide(); title_bar(s, "المخاطر وتخفيفها", 11)
table(s, [
